...
Xcode 内置、苹果官方推荐的依赖管理方式，自动处理版本与更新，无需额外工具链。

```swift
// Package.swift
dependencies: [
    .package(url: "https://github.com/doopush/doopush-ios-sdk.git", from: "1.3.0")
]
```
...
适合无法使用包管理器的离线/锁定环境；需手动升级，无自动版本管理，仅作兜底。
